...
protected:
    ...
    NVENCSTATUS                                          EncodeFrame(EncodeFrameConfig *pEncodeFrame, bool bFlush=false, uint32_t width=0, uint32_t height=0, int8_t *qpDeltaMap=NULL, uint32_t qpDeltaMapSize=0);
